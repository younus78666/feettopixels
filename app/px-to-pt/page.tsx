...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "PX to PT Converter — Convert Pixels to Points",
    description:
      "Convert between CSS pixels and typographic points. Quick reference table for common font sizes.",
    url: "/px-to-pt",
  },
};
...
const relatedTools = [
  ...
  { name: "DPI Calculator", description: "Calculate DPI for screens", href: "/dpi-calculator", icon: "🖥️" },
];
...
export default function PxToPtPage() {
  return (
    <ConverterLayout
