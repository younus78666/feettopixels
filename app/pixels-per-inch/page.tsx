...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Pixels Per Inch (PPI) Explained — Complete Reference Guide",
    description:
      "Comprehensive guide to pixels per inch (PPI) with reference charts, retina display info, and calculation formulas.",
    url: "/pixels-per-inch",
  },
};
...
export default function PixelsPerInchPage() {
  return (
    <BlogLayout
