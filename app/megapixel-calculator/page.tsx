...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Megapixel Calculator — Convert MP to Pixel Dimensions",
    description:
      "Convert between megapixels and pixel dimensions. Supports all aspect ratios and common camera presets.",
    url: "/megapixel-calculator",
  },
};
...
const breadcrumbs = [
  ...
  { label: "Megapixel Calculator", href: "/megapixel-calculator" },
];

const relatedTools = [
  { name: "Image Size Calculator", description: "Calculate physical image size", href: "/image-size-calculator", icon: "📐" },
  { name: "Image DPI Checker", description: "Check image DPI and quality", href: "/image-dpi-checker", icon: "🔍" },
...
export default function MegapixelCalculatorPage() {
  return (
    <ConverterLayout
