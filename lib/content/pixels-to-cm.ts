...
export const content: PageContentMap = {
  en: {
    ...
    body: {
      ...
      p2: "This formula first converts pixels to inches (pixels / DPI), then converts inches to centimeters (inches x 2.54). The result gives you the pixel size in real world units, which is essential for anyone working on a metric print layout or needing to export for European print.",
      ...
      p3: "Most countries outside the United States measure in metric units, making pixel to centimeter conversion a routine part of digital to physical measurement workflows. When a client asks for a screen dimension in cm, you need to work backwards from your pixel count at the target DPI. Checking whether a 1200-pixel wide image will fill a 15 cm magazine column is a typical example. Print shops in metric countries specify physical print dimensions in centimeters, so verifying pixel-to-cm calculations before sending files prevents costly reprints.",
