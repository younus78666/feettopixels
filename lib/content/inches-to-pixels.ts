...
export const content: PageContentMap = {
  en: {
    ...
    body: {
      ...
      p1: "Converting inches to pixels is essential when translating physical design specifications into digital formats. This inch to pixel conversion determines the pixel requirements for any canvas before you build, print, or export it. The formula is simple:",
